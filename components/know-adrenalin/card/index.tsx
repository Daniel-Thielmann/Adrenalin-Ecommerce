    ...
    return (
        ...
        transition-shadow transition-shadow-color duration-200 rounded-md hover:shadow-2xl gap-4">
            <Image
                ...
                width={150}
                height={150}
                className="max-h-[75] max-w-[75] xl:max-h-[150] xl:max-w-[150] 2xl:max-h-[220px] 2xl:max-w-[220px]"
            />
            <h1 className="text-center text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl cursor-default">{title}</h1>
            <p className="text-gray-400 text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl text-center line-clamp-10 cursor-default">{description}</p>
        </div>
    )
}